...
navbar = dbc.NavbarSimple(
    brand='Components of NBA Salaries',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Ian Forrest', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:ianforrest11@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/ianforrest11/dash'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/ian-forrest-24461070'),  
                ], 
                className='lead'
            )
        )
